...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : lun. 18 oct. 2021 à 13:00
...
(1, 'admin@admin.com', '5465df3fffbf173438e07cb62f00f131');
...
(40, 'Assistant commercial H/F', 'Nous recherchons un(e) collaboratrice pour un poste qui allie polyvalence et responsabilités.\r\n\r\nLe poste s’adresse à une personne impliquée, dynamique, multi taches, sympathique, disponible.\r\n\r\n- Connaissance suite office indispensable\r\n\r\n- Connaissance logiciel PAO serait un plus mais dans tous les cas un attrait pour la création (formation possible).\r\n\r\n- Connaissance SAGE gestion commerciale serait un plus\r\n\r\nAisance relationnelle, esprit commercial mais également rigueur.\r\n\r\nBac + 2/3 minimum\r\n\r\nHoraires 35 heures\r\n\r\nSalaire départ brut entre 1800€ et 2200€ pour commencer (évolutif)\r\n\r\n+ TR, mutuelle, prime été, PEE\r\n\r\nTaches :\r\n\r\nSaisir les commandes, bon de livraison, gérer les transports de plusieurs sociétés.\r\n\r\nGérer les commandes du site marchand\r\n\r\nRéalisation de plaquettes commerciales, fiche produits, catalogue, newletters\r\n\r\nRédactionnel site marchand + mise à jour de contenu\r\n\r\nClassement\r\n\r\nStandard, renseigner au téléphone\r\n\r\nLitiges transports\r\n\r\nNote de frais\r\nEtc …\r\n\r\nDate de début prévue : 25/10/2021\r\n\r\nType d\'emploi : Temps plein, CDI\r\n\r\nSalaire : 1 800,00€ à 2 200,00€ par mois\r\n\r\nAvantages :\r\n\r\nÉpargne salariale\r\nTitre-restaurant\r\nHoraires :\r\n\r\nDu Lundi au Vendredi\r\nTravail en journée\r\nRémunération supplémentaire :\r\n\r\nPrime annuelle\r\nMesures COVID-19:\r\nmasque facultatif si vaccin. accueil du public fermé.\r\n\r\nExpérience:\r\n\r\nassistant commercial H/F: 2 ans (Optionnel)', 2200, 'Sofidis', 'Aubagne', '2021-10-16', 1, 3, 'stage');
...
(35, 'test', 'test', 'test@test.test', '7fe79a0d29125094e37871e03ed0f353', '0102030405', NULL, NULL, NULL, NULL, 0x4d6f6e204356202833292e706466, NULL, NULL, NULL),
(36, NULL, NULL, 'fromagio@z.z', 'de85e4c8b2430c1c9a838f8e434f36da', '+33781296764', '13011', 'MARSEILLE', '5, ROUTE DE LA TREILLE - VILLA N°5', NULL, NULL, 'Homme', NULL, NULL);
COMMIT;
